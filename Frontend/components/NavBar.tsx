...
export const NavBar = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-gradient-to-r from-violet-600 to-indigo-600">
      {({ open }) => (
        <div className="shadow-lg">
          <div className="mx-auto max-w-7xl px-2 sm:px-8 lg:px-10">
            <div className="relative flex h-16 items-center justify-between">
              <div className="relative inset-y-0 left-0 flex items-center sm:hidden">
                {/* Mobile menu button*/}
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-FFFAF1-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
          ...
          <div>
                  <GithubCorner href="https://github.com/SakshiShah29/Hack-Commerce" size={65} />
                </div>
